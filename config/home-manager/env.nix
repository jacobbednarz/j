{
  home.sessionVariables = {
    EDITOR            = "vim";
    PATH              = "/Users/jacob/.nix-profile/bin:/run/current-system/sw/bin:/Users/jacob/.asdf/shims:/Users/jacob/bin:/Users/jacob/.go/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin/";
